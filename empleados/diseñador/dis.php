...
$queryusuarios = mysqli_query($conexion, "SELECT nd,user,correo,descripcion,estatus, asignar FROM tickets where asignar='Diseñador' and user like '".$buscar."%'");
}
else
{
$queryusuarios = mysqli_query($conexion, "SELECT * FROM tickets where asignar='Diseñador' ORDER BY nd asc");
}
		$numerofila = 0;
